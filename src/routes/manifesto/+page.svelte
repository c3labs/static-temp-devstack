...
<svelte:head>
	<title>{m.manifest_title()} | c3labs</title>
	<meta name="description" content="{m.manifest_meta_description()}">

	<!-- Open Graph for Facebook, LinkedIn, WhatsApp -->
	<meta property="og:title" content="{m.manifest_title()} | c3labs">
	<meta property="og:description" content="{m.manifest_meta_description()}">
	<!-- X (Twitter) Cards -->
    <meta name="twitter:title" content="{m.manifest_title()} | c3labs">
	<meta name="twitter:description" content="{m.manifest_meta_description()}">
</svelte:head>
<div class="grid-global">
    <header data-animate="true" class="hero text-hero relative">
        ...
        <h2 class="split title p-5 text-5xl lg:col-start-2 lg:pt-55 lg:text-6xl lg:border-l text-wrap tracking-tighter">{m.manifest_headline()}</h2>
    ...
    <section data-animate="true" class="relative flex flex-col lg:col-start-2 lg:col-span-2 lg:grid lg:grid-cols-2">
        <a class="group relative min-h-87.5 flex flex-col justify-between overflow-hidden gap-6 p-5 border-b lg:col-span-2 lg:min-h-112.5 lg:border-l" href="/manifesto/what-isitagentready-com-actually-measures">
            <enhanced:img src="/src/lib/assets/images/manifesto/isitagentready.v2.png?format=avif" alt="Featured article cover" class="-z-10 absolute h-full w-full object-cover top-0 left-0 right-0 bottom-0" sizes="(min-width: 1024px) 66.66667vw, 100vw" />
        ...
        <div class="order-1 flex h-full flex-col lg:order-2 lg:border-l">
            ...
            <a title="llms.txt: Helping AI Understand Your Website" class="relative grid grid-cols-2 border-b lg:h-3/4 card-hover -mb-px overflow-hidden" href="/manifesto/llms-txt-helping-ai-understand-your-website">
                <div class="relative">
                    <enhanced:img src="/src/lib/assets/images/manifesto/temporal_3.png?format=avif" alt="Featured article cover" class="-z-10 absolute h-full w-full object-cover" sizes="(min-width: 1024px) 16.66667vw, 50vw" />
                </div>
