...
<svelte:head>
	<title>{m.manifest_1_headline()} | c3labs</title>
	<meta name="description" content="{m.manifest_1_meta_description()}">

	<!-- Open Graph for Facebook, LinkedIn, WhatsApp -->
	<meta property="og:title" content="{m.manifest_1_headline()} | c3labs">
	<meta property="og:description" content="{m.manifest_1_meta_description()}">
	<!-- X (Twitter) Cards -->
    <meta name="twitter:title" content="{m.manifest_1_headline()} | c3labs">
	<meta name="twitter:description" content="{m.manifest_1_meta_description()}">
</svelte:head>
<button
	in:fade
	onclick={() => {
...
<header class="article-hero hero">
	<div class="relative lg:col-span-3">
		<div class="grid-global relative h-75 lg:h-150">
			...
			<enhanced:img
				src="/src/lib/assets/images/manifesto/isitagentready.v2.png?format=avif"
