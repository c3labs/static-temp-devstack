	...
	<div class="grid-global portfolio-grid">
		<a class="card-hover flex flex-col group" target="" rel="" href="/portfolio/subway">
			<div class="relative min-h-75 grow">
				<enhanced:img src="/src/lib/assets/images/portfolio/subway_hero@2x.jpg?format=avif" alt="Subway Website in Forest" class="object-cover object-center w-full h-full absolute" sizes="(min-width: 1024px) 33.3333vw, 100vw" />
		...
		<a class="card-hover flex flex-col group" target="" rel="" href="/portfolio/werkd">
			<div class="relative min-h-75 grow">
				<enhanced:img src="/src/lib/assets/images/portfolio/werkd_ArtBoard1@2x.jpg?format=avif" alt="werk d Website Preview" class="object-cover object-center w-full h-full absolute" sizes="(min-width: 1024px) 66.66667vw, 100vw" />
				<div class="absolute inset-0 bg-black opacity-0 lg:opacity-10 group-hover:opacity-0 transition-opacity duration-300" aria-hidden="true"></div>
			</div>
			<div class="flex items-center justify-between p-5 min-h-20">
