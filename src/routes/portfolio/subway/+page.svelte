...
<header in:fade class="hero case-study-hero">
    <div class="absolute w-full h-full">
        <enhanced:img src="/src/lib/assets/images/portfolio/subway_hero@2x.png?format=avif" alt="Subway Website Preview" class="absolute w-full h-full object-cover object-center" sizes="(min-width: 1024px) 66.66667vw, 100vw" />
    </div>
...
<div class="grid-global relative order-2">
	...
	<div class="flex flex-col p-5 font-menu text-xs uppercase md:py-12 lg:border-y-0">
		...
		<ul class="flex flex-col items-start gap-1 text-sm"><li>Sports | Retail</li></ul>
	</div>
...
<div class="order-1 col-span-3 flex grid-cols-1 flex-col lg:order-2 lg:grid lg:grid-cols-3">
    ...
    <div class="max-lg:order-1 h-full w-full object-cover col-span-2">
        <enhanced:img src="/src/lib/assets/images/portfolio/subway_screens_top@2x.png?format=avif" alt="Subway Website Screens #1" sizes="(min-width: 1024px) 66.66667vw, 100vw" />
    </div>
</div>
<section class="section _section-threes">
    ...
    <!-- <div class="max-lg:order-1 h-full w-full object-cover pt-10 col-span-3">
        <enhanced:img src="/src/lib/assets/images/portfolio/subway_screens_mid@2x.png?format=avif" alt="Subway Website in Forest" sizes="(min-width: 1024px) 66.66667vw, 100vw" />
    </div> -->
</section>
<section class="section">
    <div class="max-lg:order-1 h-full w-full object-cover pt-10 col-span-2">
        <enhanced:img src="/src/lib/assets/images/portfolio/subway_screens_bot@2x.png?format=avif" alt="Subway Website Screens #2" sizes="(min-width: 1024px) 66.66667vw, 100vw" />
    </div>
...
<style>
    ...
    .mediapanel {
        overflow: hidden;
        border-radius: 2.2vw;
        border: .55vw solid var(--color-neutral-900);
        width: stretch;
